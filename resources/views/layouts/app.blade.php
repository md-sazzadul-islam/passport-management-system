...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <header class="app-header navbar">
        ...
        <a class="navbar-brand" href="#">
            <img class="navbar-brand-full" src="{{ asset('/storage/' . $app_logo) }}" width="30" height="40"
                alt="{{ $app_name }}">
            <img class="navbar-brand-minimized" src="{{ asset('/storage/' . $app_logo) }}" width="30"
                height="40" alt="{{ $app_name }}">
        </a>
    ...
    <footer class="app-footer">
        <div>
            <a href="http://sazzadul.com">Md Sazzadul Islam</a>
